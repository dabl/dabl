...
def get_any_classifiers():
    sklearn_ests = [
        ...
        HistGradientBoostingClassifier(l2_regularization=10.0, learning_rate=1.0,
                                       loss='auto', max_bins=256, max_depth=12,
        ...
        HistGradientBoostingClassifier(l2_regularization=1e-08, learning_rate=0.1,
                                       loss='auto', max_bins=32, max_depth=6,
                                       max_iter=500, max_leaf_nodes=4,
                                       min_samples_leaf=19, n_iter_no_change=None,
                                       random_state=14210, scoring=None, tol=1e-07,
                                       validation_fraction=0.2, verbose=0),
        ...
        HistGradientBoostingClassifier(l2_regularization=100.0, learning_rate=0.1,
                                       loss='auto', max_bins=256, max_depth=14,
        ...
        HistGradientBoostingClassifier(l2_regularization=100000.0, learning_rate=1.0,
                                       loss='auto', max_bins=16, max_depth=2,
                                       max_iter=400, max_leaf_nodes=64,
                                       min_samples_leaf=14, n_iter_no_change=None,
                                       random_state=22357, scoring=None, tol=1e-07,
                                       validation_fraction=0.2, verbose=0),
        ...
        HistGradientBoostingClassifier(l2_regularization=10.0, learning_rate=0.1,
                                       ...
                                       random_state=1718, scoring=None, tol=1e-07,
                                       validation_fraction=0.2, verbose=0),
        ...
        HistGradientBoostingClassifier(l2_regularization=0.1, learning_rate=0.1,
                                       loss='auto', max_bins=256, max_depth=4,
                                       max_iter=350, max_leaf_nodes=128,
                                       min_samples_leaf=11, n_iter_no_change=None,
                                       random_state=19582, scoring=None, tol=1e-07,
                                       validation_fraction=0.1, verbose=0),

        HistGradientBoostingClassifier(l2_regularization=1.0, learning_rate=1.0,
                                       loss='auto', max_bins=128, max_depth=2,
                                       max_iter=50, max_leaf_nodes=32,
                                       min_samples_leaf=3, n_iter_no_change=None,
                                       random_state=49381, scoring=None, tol=1e-07,
                                       validation_fraction=0.2, verbose=0),

        HistGradientBoostingClassifier(l2_regularization=1e-07, learning_rate=0.1,
                                       loss='auto', max_bins=16, max_depth=3,
                                       max_iter=350, max_leaf_nodes=16,
                                       min_samples_leaf=14, n_iter_no_change=None,
                                       random_state=14350, scoring=None, tol=1e-07,
                                       validation_fraction=0.1, verbose=0)
        ]
